...
import {MemeCoin} from "../src/meme20Tax.sol";
...
contract MemeCoinTest is Test {
    ...
    function testConstructor() public {
        ...
        assertEq(
            memecoin.maxHoldingPerWallet(),
            (initialSupply * 1 ether * maxHoldingPercent) / PRECISION
        );
    ...
    function testTransferTax() public {
        ...
        uint256 expectedBalance = transferAmount -
            (transferAmount * tax) /
            PRECISION;
        ...
        assertEq(
            memecoin.balanceOf(to),
            transferAmount - (transferAmount * tax) / PRECISION
        );
        vm.stopPrank();
    }
}
